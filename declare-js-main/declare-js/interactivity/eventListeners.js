...
export function addEventListeners(container) {
  ...
  container.canvas.addEventListener("click", (evt) => {
    switch (container.mode) {
      case "MOVE":
        if (container.enableEdit) activitySelection.selection(evt, container);
        break;
      case "ACTIVITY_PLACEMENT":
        activityPlacement.place(evt, container);
        break;
      case "EXISTENCE_CONSTRAINT_PLACEMENT":
        existenceConstraintPlacement.place(evt, container);
        break;
      case "SELECT_RELATION_CONSTRAINT_START":
        relationConstraintPlacement.start(evt, container);
        break;
      case "SELECT_RELATION_CONSTRAINT_END":
        relationConstraintPlacement.end(evt, container);
        break;
  ...
  container.canvas.addEventListener("mousemove", (evt) => {
    switch (container.mode) {
      ...
      case "ACTIVITY_PLACEMENT":
        ...
        break;
      case "EXISTENCE_CONSTRAINT_PLACEMENT":
        existenceConstraintPlacement.move(evt, container);
        break;
      case "SELECT_RELATION_CONSTRAINT_END":
        relationConstraintPlacement.move(evt, container);
        break;
      default:
  ...
  document.addEventListener("keydown", (evt) => {
    if (evt.key === "Escape") {
      switch (container.mode) {
        case "ACTIVITY_PLACEMENT":
          activityPlacement.abort(evt, container);
          break;
        case "EXISTENCE_CONSTRAINT_PLACEMENT":
          existenceConstraintPlacement.abort(evt, container);
          break;
        case "SELECT_RELATION_CONSTRAINT_START":
        case "SELECT_RELATION_CONSTRAINT_END":
          relationConstraintPlacement.abort(evt, container);
          break;
      }
    }
